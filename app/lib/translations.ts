...
export const translations = {
  pt: {
    ...
    dashboard: {
      ...
      profileNote: "Os dados seguintes nunca serão partilhados e servem apenas para fins estatísticos. Este preenchimento é obrigatório para concluir o primeiro acesso.",
      fillRequired: "Preencha: data de nascimento e género.",
      completeAccess: "Concluir primeiro acesso",
      completing: "A concluir...",
      birthDateRequired: "Preencha data de nascimento e género para concluir o primeiro acesso.",
  ...
  en: {
    ...
    dashboard: {
      ...
      profileNote: "The following data will never be shared and is for statistical purposes only. This completion is required to finish your first access.",
      fillRequired: "Fill in: date of birth and gender.",
      completeAccess: "Complete First Access",
      completing: "Completing...",
      birthDateRequired: "Fill in date of birth and gender to complete your first access.",
