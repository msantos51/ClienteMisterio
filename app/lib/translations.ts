...
export const translations = {
  pt: {
    ...
    dashboard: {
      ...
      updatePersonal: "Atualize os seus dados pessoais e guarde as alterações.",
      ...
      fillRequired: "Preencha: data de nascimento.",
      completeAccess: "Concluir primeiro acesso",
      completing: "A concluir...",
      birthDateRequired: "Preencha a data de nascimento para concluir o primeiro acesso.",
      securityTitle: "Segurança da conta",
      securePassword: "Defina uma palavra-passe forte para proteger o seu acesso.",
      ...
      deleteWarning: "Apagar a conta remove permanentemente o seu perfil, progresso e histórico.",
      deleteAccountPassword: "Senha atual para apagar conta",
      deleteAccount: "Apagar conta",
      deleting: "A apagar conta...",
      deleteConfirmation: "Esta ação é irreversível. Tem a certeza de que pretende apagar a sua conta?",
      preferencesTitle: "Preferências",
      chooseUpdates: "Escolha como pretende receber atualizações da plataforma.",
      newsletter: "Receber newsletter",
      notifications: "Notificações da comunidade",
      logout: "Terminar sessão",
      secureAccount: "Conta segura",
      accountTip: "Use o menu lateral para navegar entre perfil, segurança e preferências sem perder o foco.",
      loading: "A carregar perfil...",
      passwordFieldsRequired: "Preencha a senha atual e a nova senha com confirmação.",
      passwordMismatch: "A confirmação da nova senha deve ser igual à nova senha.",
      deletePasswordRequired: "Informe a senha atual para confirmar a eliminação da conta.",
    },
    ...
    coursePlayer: {
      ...
      completionDesc: "Complete todos os módulos para obter a sua certificação. Cada módulo inclui conteúdo teórico e um questionário de avaliação.",
      ...
      quizInstruction: "Responda a todas as questões. Necessita de 60% para concluir o módulo.",
      submitAnswers: "Submeter Respostas",
      congrats: "Parabéns!",
      tryAgainQuiz: "Tente novamente",
      scored: "Obteve",
      inThisQuiz: "neste questionário.",
      savingProgress: "A guardar progresso...",
      moduleCompleted: "Módulo concluído com sucesso!",
      needMorePoints: "Necessita de pelo menos 60% para avançar. Reveja o conteúdo e tente novamente.",
      backToModulesList: "Voltar aos Módulos",
      reviewContent: "Rever Conteúdo",
      retakeQuiz: "Repetir Quiz",
      backToContent: "Voltar ao conteúdo",
      certificateDesc: "Este módulo disponibiliza o seu Certificado de Conclusão em PDF com nome personalizado.",
    ...
    catalog: {
      ...
      include5: "Acesso vitalício — estude ao seu ritmo",
