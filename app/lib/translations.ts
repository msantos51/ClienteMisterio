...
export const translations = {
  pt: {
    ...
    contact: {
      ...
      emailLabel: "Email",
      email: "clientemisterio.suporte@gmail.com",
    ...
    dashboard: {
      ...
      newsletterDescription: "Novidades do curso e da plataforma, sem spam.",
      notifications: "Notificações da comunidade",
      notificationsDescription: "Alertas sobre o teu progresso e a atividade da comunidade.",
      logout: "Terminar sessão",
    ...
    termsAndConditions: [
      ...
      },
      {
        ...
        content: "Nos termos da legislação portuguesa, o consumidor tem acesso ao Livro de Reclamações Eletrónico em www.livroreclamacoes.pt. Em caso de litígio de consumo, o consumidor pode ainda recorrer a uma Entidade de Resolução Alternativa de Litígios de Consumo — a lista de entidades disponíveis pode ser consultada em www.consumidor.gov.pt.",
      },
    ],
  ...
  en: {
    ...
    dashboard: {
      ...
      newsletterDescription: "Course and platform news, no spam.",
      notifications: "Community Notifications",
      notificationsDescription: "Alerts about your progress and community activity.",
      logout: "Sign Out",
    ...
    termsAndConditions: [
      ...
      },
      {
        ...
        content: "Under Portuguese law, consumers can access the Electronic Complaints Book at www.livroreclamacoes.pt. In case of a consumer dispute, consumers may also resort to a Consumer Alternative Dispute Resolution entity — the list of available entities can be consulted at www.consumidor.gov.pt.",
      },
    ],
