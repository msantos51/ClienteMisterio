...
export const courseModules: CourseModule[] = [
 ...
 content: [
  ...
  "Conflitos de interesse — declarar logo! Trabalhas na loja a avaliar? Tens um familiar lá? Amas muito a marca? Declara ANTES de aceitar. Não vale a pena arriscar.",
 ...
 "⏱ Checklist de ouro pós-visita: Tenho o talão legível? Fotos claras e bem focadas? Revis os briefing outra vez? Registei observações nos primeiros 15 minutos? Tenho horas de entrada e saída? Algo invulgar → comunica já à agência.",
 ],
 quiz: [
 {
 id: "m7q1",
